    ...
    <div className="w-full h-max flex flex-col items-center justify-center bg-[#26211d]">
     ...
     <div className="w-[90%] h-[10vh] flex justify-between ">
        <div className="w-[50%] flex items-center ">
            <div className="hidden max-[700px]:w-8 max-[700px]:h-8 max-[700px]:flex max-[700px]:items-center "><img src="/src/assets/icons/menu.png" alt="" /></div>
        ...
        <div className="w-[50%] flex justify-end items-center space-x-4">
          ...
          <div className="w-[35px] h-[35px] bg-black rounded-full ">rdd</div>
        </div>
      </div>
     </div>
    </div>
